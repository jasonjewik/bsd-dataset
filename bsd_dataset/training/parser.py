...
def parse_args():
    ...
    parser.add_argument("--no_train", action = "store_false", default = True, help = "No training")
    parser.add_argument("--no_val", action = "store_false", default = True, help = "No validation")
    parser.add_argument("--no_test", action = "store_false", default = True, help = "No test")
    ...
    parser.add_argument("--epochs", type = int, default = 16, help = "Number of train epochs")
