...
def parse_args():
    ...
    parser.add_argument("--model", type = str, default = "RN50", choices = ["RN50", "RN101"], help = "Model name")
    parser.add_argument("--context_data", type = str, default = None, help = "")
    parser.add_argument("--target_data", type = str, default = None, help = "")
